...
(function () {
    ...
    function checkRequirements() {
        ...
        if (!Modernizr.getusermedia) {
            deferred.reject('please check your hardware');
        }
        ...
        if (Modernizr.webgl) {
            try {
                ...
                deferred.reject('It seems the library failed to run ( glfx.js), it seems it might WebGL issues?');
            }
        } else {
            deferred.reject(' it looks like your browser doesn\'t support WebGL.');
        }
    ...
    function setupVideo(rearCameraId) {
        ...
        getUserMedia(videoSettings, function (stream) {
            ...
            deferred.reject(' It seems that we can\'t camera, have you denied it?');
        });
    ...
    function step3() {
        ...
        //Convert ctx (a canvas) to cropped (an image), and then use runOCR(cropped)
